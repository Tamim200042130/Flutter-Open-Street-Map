              ...
              : Scaffold(
                  ...
                  appBar: PreferredSize(
                      ...
                      child: AppBar(
                        ...
                        actions: <Widget>[
                          if (MediaQuery.of(context).size.width < 500) Container(height: 0, width: 9) else Container(
                                  child: Container(
                                  padding:
                          ...
                          ///download option
                          if (model.isMobileResolution) Container() else Container(
